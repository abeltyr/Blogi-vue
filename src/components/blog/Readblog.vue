  ...
  <v-flex xs12>
    <div>
      <v-layout v-bind="layoutAttributes">
        <v-flex x12 md8 offset-md2>
          <a-card :loading="loading" style="width: 80%; margin-left:10%; margin-top:5%; box-shadow:1px 25px 20px grey;">
            <a-card :loading="loading" class="mb-4" style="border-radius:15px;">
              <img  alt="example" :src="blog.image" slot="cover"  style="border-radius:15px;"/>
            </a-card>
          ...
          <v-layout fill-height>
            <v-flex xs12 align-end flexbox >
              <span >
                <span style="color:#212121; font-size:15px;">
                  Writen BY
                </span>    
                <router-link :to="{name: 'User', params:{id : blog.user_id, name : user.name}}" class=" font_bottomt"> 
                      {{user.name}} 
                </router-link>
              </span>
            </v-flex>
          ...
          <v-flex xs12 class="mt-2" style="width: 100%;">
              <v-flex xs4 style="text-align:center; font-size:15px; color:#ff0000;">
                {{likes}}
              </v-flex>
          </v-flex>
          </a-card>
